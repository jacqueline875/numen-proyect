    ...
    return (
        <div className="container px-4 mx-auto py-9 md:py-12 md:px-6">
            <div className="flex flex-col justify-center space-y-4 items-strech md:flex-row md:space-y-0 md:space-x-6 lg:space-x-8">
                <div className="flex flex-col justify-between px-6 py-6 rounded-lg md:flex-row items-strech bg-gradient-to-l from-purple to-bermuda md:py-12 lg:px-12 md:w-8/12 lg:w-7/12 xl:w-8/12 2xl:w-9/12">
                ...
                <div className="relative flex flex-col justify-center px-6 py-6 rounded-lg md:w-4/12 lg:w-5/12 xl:w-4/12 2xl:w-3/12 bg-gradient-to-r from-purple to-bermuda md:py-0 md:px-4 lg:px-6">
